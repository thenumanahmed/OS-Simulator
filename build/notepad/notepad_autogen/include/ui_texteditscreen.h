...
public:
    ...
    void setupUi(QMainWindow *TextEditScreen)
    {
        ...
        actionClose = new QAction(TextEditScreen);
    ...
    void retranslateUi(QMainWindow *TextEditScreen)
    {
        ...
        actionClose->setText(QApplication::translate("TextEditScreen", "Close", nullptr));
#ifndef QT_NO_SHORTCUT
        actionClose->setShortcut(QApplication::translate("TextEditScreen", "Ctrl+Esc", nullptr));
#endif // QT_NO_SHORTCUT
